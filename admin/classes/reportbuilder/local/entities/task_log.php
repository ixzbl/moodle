...
class task_log extends base {
            ...
            ->add_callback(static function($value, stdClass $row): string {
                ...
                if (class_exists($classname)) {
                    ...
                    if ($task instanceof \core\task\task_base) {
                        // Move Task ID to the heading by appending it after the task name
    ...
    protected function get_all_filters(): array {
        ...
        $filters[] = (new filter(
            number::class,
            'id',
            new lang_string('taskid', 'admin'),  // Label for the Task ID filter.
            $this->get_entity_name(),
            "{$tablealias}.id"  
        ))
            ->add_joins($this->get_joins());
        ...
        $filters[] = (new filter(
            text::class,
            'custom_data',
            new lang_string('taskcustomdata', 'admin'),  // Label for the Custom Data filter.
            $this->get_entity_name(),
